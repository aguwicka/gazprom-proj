...
// General Vars
var $app = $('.app');
var $appHeader = $('.app-header'); // Смена темы
...
var sectionContents = document.querySelectorAll(".app-section__content");
...
var observer = new IntersectionObserver(check, options);
sectionContents.forEach(function (sectionContent) {
  return observer.observe(sectionContent);
