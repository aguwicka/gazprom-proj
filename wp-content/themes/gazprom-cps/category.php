            ...
            <article class="layout-news news-page">
                ...
                <div class="news-page__aside">
                    <div class="news-addons">
                        ...
                        <?php if (carbon_get_theme_option('crb_news_phone') || carbon_get_theme_option('crb_footer_email')): ?>
                            <div class="news-addons__group">
                                <div class="news-addons__group-title typo--subtitle2">Контакты для СМИ</div>
                                <div class="news-addons__group-item"><?= carbon_get_theme_option('crb_news_phone'); ?></div>
                            ...
                            if ($query->have_posts()) :
                                while ($query->have_posts()) : $query->the_post();
                                    ...
                                    <div class="news-list-card">
                                        ...
                                        <div class="news-list-card__title typo--subtitle2"><a
